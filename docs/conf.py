...
module_dir = os.path.join(__location__, "../src/smos")
try:
...
try:
    from smos import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
    ("index", "user_guide.tex", "smos Documentation", "TU Wien", "manual")
]
